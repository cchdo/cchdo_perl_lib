...
# 					corrected paths
# S. Diggs:		2009.06.01:	Changed script name.  This version
#					is for older *.ctd files without
#					TRANS and/or FLUOR parameters.
#
# S. Diggs:		2009.08.24	You'll need to change the write_ctd
#					function now if you wish to process
#					non-numeric station IDs!
#------------------------------------------------------------------------
my $software_version = "CTD_Exchange_Encode_v1.1b(CCHDO/Diggs)";
